...
import PaymentMethodsRepository from '@domain/payment-methods/repositories/PaymentMethodsRepository'
import PaymentMethodsUseCase from '@domain/payment-methods/use-cases/PaymentMethodsUseCase'
import { CreatePaymentMethodsController } from '@presentation/http/controllers/payment-methods/CreatePaymentMethodsController'
import { PaymentMethodsRoutes } from '@presentation/http/routes/PaymentMethodsRoutes'
import ServiceTypeRepository from '@domain/service-type/repositories/ServiceTypeRepository'
import ServiceTypeUseCase from '@domain/service-type/use-cases/ServiceTypeUseCase'
import { CreateServiceTypeController } from '@presentation/http/controllers/service-type/CreateServiceTypeController'
import { ServiceTypeRoutes } from '@presentation/http/routes/ServiceTypeRoutes'
import { ListPaymentMethodsController } from '@presentation/http/controllers/payment-methods/ListPaymentMethodsController'
import { ListServiceTypeController } from '@presentation/http/controllers/service-type/ListServiceTypeController'
